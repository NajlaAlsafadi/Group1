	...
	public static void main(String[] args) {
		...
		addItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JLabel dateLbl = new JLabel("Item's expiration date:");
				Date date1 = new Date();
				SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
			    JFormattedTextField expDate = new JFormattedTextField(date1);
			    ...
			    //Item dialog box
			    int addItms = JOptionPane.showOptionDialog(null, new Object[] {itmLbl,space,itmNameLbl,itmTfld,typeLbl,typeBox,dateLbl,expDate,amtLbl,amtTfld},
			    ...
			    if(addItms == JOptionPane.OK_OPTION) {
			    	...
			    	//else if(date2.before(date1)) {
			    		...
			    		//JOptionPane.showMessageDialog(null, new Object[] {emptyItmErr}, "Date error", JOptionPane.ERROR_MESSAGE);
			    	...
			    	//}
			    		...
			    		Item item = new Item(itmTfld.getText(),itmType,price,amount,date2);
			    		itemList.add(item);
		...
		JMenuItem delItem = new JMenuItem("Delete item");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(itemList.isEmpty()) {
					...
					for(int i = 0; i < itemList.size(); i++) {
						...
						String itmName = itemList.get(i).getItmName();
					...
					int delItm = JOptionPane.showOptionDialog(null, new Object[] {delLbl, delBox},
							"Delete Item", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null, null, null);
